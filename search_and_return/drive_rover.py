...
class RoverState():
    def __init__(self):
        ...
        self.ob_angles = None #Angles of obstacle pixels
        self.ob_dists = None #Distances of obstacle pixels
        self.seeSample = False
        ...
        self.change_dir = 5500
        self.max_vel = 1.75 # Maximum velocity (meters/second)
        self.max_collect_vel = 1.0 #max velocity when collecting
        ...
        self.navmap = np.zeros((2000, 2000), dtype=np.float)
