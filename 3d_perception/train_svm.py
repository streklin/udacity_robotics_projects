...
# Create classifier, use grid search to find good fit
#clf = svm.SVC(kernel='rbf', C=0.01, gamma=1000)
#parameters = {'kernel':('linear', 'rbf', 'poly'), 'C':[0.001, 0.01, 0.1, 1, 10, 100, 1000], 'gamma': [0.001, 0.01, 0.1, 1, 10, 100, 1000]}
#srch = GridSearchCV(svc, parameters)
